<div class="opacity-90 flex flex-col gap-1">
	<p>
		...
		Software Engineer at <a href="https://thefa.com" class="underline text-tmux"
	...
	<p>
		...
		<a href="https://svelte.dev/" class="underline text-tmux">Svelte</a>,
		<a href="https://www.typescriptlang.org/" class="underline text-tmux">TypeScript</a>,
		<a href="https://go.dev/" class="underline text-tmux">Go</a>, and
		<a href="https://tailwindcss.com/" class="underline text-tmux">TailwindCSS</a>.
	</p>
	<p>
		...
		<a href="https://dora.dev" class="underline text-tmux">DevOps</a>
		and CI/CD.
	</p>
	<p>
	...
	<p>
		...
		<a href="mailto:paul@dolden.co.uk" class="underline text-tmux">here</a> or connect with me on
		<a href="https://linkedin.com/in/pauldolden" class="underline text-tmux">LinkedIn</a>.
	</p>
</div>
